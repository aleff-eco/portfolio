  ...
  return (
    <section id="experience" className="py-20 bg-background text-foreground">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="h-1 w-32 mx-auto mb-16 rounded-full bg-border" />
            ...
            {shownKeys.map((key, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="hidden md:block absolute left-1/2 -translate-x-1/2 top-8 w-4 h-4 rounded-full border-4 border-background bg-background ring-1 ring-border/60" />
                  ...
                  >
                    ...
                    >
                      <div className="w-full p-3 rounded-lg shadow-lg border-l-4 border-indigo-500 bg-[hsl(var(--background-secondary))] text-foreground">
                        <div className="flex items-center justify-between gap-4">
                          <div className="flex items-center gap-4 min-w-0">
                            ...
                            <a
                              ...
                              className="text-lg font-semibold transition hover:opacity-90 truncate"
                            >
                              {item.company}
                            </a>
                          </div>
                    ...
                    <div className="md:w-1/2">
                      <div className="p-6 rounded-lg shadow-lg border border-border/50 bg-[hsl(var(--background-secondary))] text-foreground">
