    ...
    <section className="w-full py-12 md:py-16 lg:py-20 flex justify-center items-center">
      <div className="container flex flex-col items-center gap-8">
        <div className="grid gap-2 text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-2xl md:text-3xl">Compañías a las que he aportado valor</h2>
        ...
        >
          <div className="flex gap-6 px-4 md:gap-8 md:px-6 h-32">
            {[...companies, ...companies].map((company, index) => (
              <div key={index} className="flex-shrink-0 group">
                <div className="relative py-4 px-8 h-32 w-64 overflow-hidden rounded-lg bg-muted transition-all duration-300 group-hover:scale-105 group-hover:shadow-lg flex justify-center items-center">
                  <img
