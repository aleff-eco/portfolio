    ...
    <footer className="bg-primary text-primary-foreground py-6">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between">
        <div className="flex flex-col md:flex-row items-center gap-x-2">
          ...
          <ul className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm mt-3 md:mt-0 text-white/80">
            <li>
              <a
        ...
        <div className="text-right text-white/80">
          <div className="mr-8">&copy; 2024 Aleff Espinosa Córdova.</div>
        </div>
      </div>
    </footer>
  );
